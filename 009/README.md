...
Текстовые файл result02.txt с текстом команд и результатом их выполнения помещены в git репозиторий.se
...
Текстовые файлы result03.txt c текстом команд и результатом их выполнения помещены в git репозиторий.